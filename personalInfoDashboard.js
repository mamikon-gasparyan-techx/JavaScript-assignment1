...
let firstName = "Mamikon";
let lastName = "Gasparyan";
let birthYear = 2005;
...
console.log("Type coersion of === is",ageString === ageNumber);
console.log(`Type of ageNumber:`,typeof ageNumber,`, Type of ageString:`,typeof ageString);
...
let status = (grade === 'C' || grade === 'B' || grade === 'A') ? "You passed":"You failed";
console.log(status);
